...
<body data-offset="200" data-spy="scroll" data-target=".ownavigation">
					...
					<div class="collapse navbar-collapse" id="navbar">
						<ul class="navbar-nav">
							<li class="active dropdown">
								...
								<a class="nav-link dropdown-toggle" title="Home" href="#inicio">Início</a>
							</li>
	...
	<div class="main-container">
		...
		<main class="site-main">
					...
					<div id="taxi-1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.6">
						<ul>	
							...
							<li data-index="rs-89" data-transition="cube-horizontal,cube,incube-horizontal,incube" data-slotamount="default,default,default,default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default,default,default,default" data-easeout="default,default,default,default" data-masterspeed="default,default,default,default" data-thumb="assets/images/taxi-1-100x50.jpg" data-rotate="0,0,0,0"  data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
								<!-- MAIN IMAGE -->
								<img src="assets/images/driving2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
							...
							<!-- SLIDE  -->
							<li data-index="rs-90" data-transition="cube-horizontal,cube,incube-horizontal,incube" data-slotamount="default,default,default,default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default,default,default,default" data-easeout="default,default,default,default" data-masterspeed="default,default,default,default" data-thumb="assets/images/taxi-1-100x50.jpg" data-rotate="0,0,0,0"  data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
								<!-- MAIN IMAGE -->
								<img src="assets/images/driving3.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->

								<!-- LAYER NR. 9 -->
								<div class="tp-caption silde-title" id="slide-90-layer-1" 
									data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
									data-y="['middle','middle','middle','middle']" data-voffset="['-31','-30','-110','-130']" 
									data-fontsize="['60','46','38','23']"
									data-width="none"
								...
								<!-- LAYER NR. 10 -->
								<div class="tp-caption tp-resizeme" id="slide-90-layer-3" 
									data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
									data-y="['middle','middle','middle','middle']" data-voffset="['29','29','-51','-86']" 
									data-width="none"
									data-height="none"
								...
								<!-- LAYER NR. 12 -->
								<div class="tp-caption rev-btn slide-btn" id="slide-90-layer-5" 
									data-x="['center','center','center','center']" data-hoffset="['1','1','1','1']" 
									data-y="['middle','middle','middle','middle']" data-voffset="['161','161','81','101']" 
									data-width="none"
									data-height="none"
			...
			<!-- What We Do Section -->
			<div class="what-we-do-section"id="nossos">
				<!-- Container -->
				<div class="container">
					<!-- Section Header -->
					...
					<div class="what-do-boxes" >
						...
						<div class="row">
							...
							<div class="col-md-6 what-do-box">
								<div class="icon-content-box">
									<i><img src="assets/images/moto-icon.png" alt="Icon" /></i>
									<b><h4>TM Moto</h4></B>
									<p>Serviço de mobilidade urbana de forma ágil e barata através do uso de motocicletas.</p>
								</div>
							</div>
							<div class="col-md-6 what-do-box">
								<div class="icon-content-box">
									<i><img src="assets/images/mulher.png" alt="Icon" /></i>
									<b><h4>TM Mulher</h4></B>
									<p>Serviço exclusivo com motoristas mulheres para oferecer maior conforto e segurança às nossas clientes.</p>
								</div>
							</div>
							<div class="col-md-6 what-do-box">
								<div class="icon-content-box">
									<i><img src="assets/images/mercado.png" alt="Icon" /></i>
									<b><h4>TM Mercado</h4></B>
									<p>Serviço de delivery de mercadorias, receba suas compras em casa através de um de nossos motoristas parceiros.</p>
								</div>
							</div>
						</div><!-- Row /- -->
						<div class="img-block">
							<img src="assets/images/imagem2.png" alt="What We Do" />
						</div>
					</div>
				</div><!-- Container /- -->
										...
										<div class="choose-slide-content">
											<div class="row">
												<div class="col-lg-7">
													...
													<p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsu nec sagittis sem nibh id elit.Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsu nec sagittis sem nibh id elit.Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ielit.</p>
						...
						<div class="tab-pane fade" id="hybrid" role="tabpanel" aria-labelledby="hybrid-tab">
							<div id="choose_2" class="choose-main">
								<div class="choose-thumbnail owl-carousel owl-theme">
									<div class="item" data-choose="1"><img src="assets/images/choose-1.jpg" alt="choose" /></div>
									<div class="item" data-choose="2"><img src="assets/images/choose-2.jpg" alt="choose" /></div>
									<div class="item" data-choose="3"><img src="assets/images/choose-3.jpg" alt="choose" /></div>
									<div class="item" data-choose="4"><img src="assets/images/choose-4.jpg" alt="choose" /></div>
									<div class="item" data-choose="5"><img src="assets/images/choose-5.jpg" alt="choose" /></div>
									<div class="item" data-choose="6"><img src="assets/images/choose-6.jpg" alt="choose" /></div>
								</div>
		...
		<div class="bottom-footer">
			...
			<div class="container">
				<div class="ftr-content">
					<p>&copy;  Copyright My Help 2021. Todos os direitos reservados</p>
				</div>
			</div><!-- Container /- -->
		</div>
	</div><!-- Footer Section /- -->
