...
<body data-offset="200" data-spy="scroll" data-target=".ownavigation">
	...
	<div class="main-container">
		...
		<main class="site-main">
			...
			<div class="about-section" id= "sobre" >
				...
				<div class="container">
					<div class="callout-detail">
						<h3>Seja um motorista Tolle Mobi e aumente sua renda</span></h3>
						<h6>FALE CONOSCO : <a href="https://api.whatsapp.com/send?phone=5566996916027&text=Ol%C3%A1,%20gostaria%20de%20me%20tornar%20um%20motorista%20Tolle%20Mobi!">(66) 99691-6027</a></h6>
						<a href="#motorista" title="Book Now">BAIXE O APP</a>
					</div>
				</div><!-- Container /- -->
				</div><!-- callout Section /- -->
			...
			<!-- Choose Section -->
			<div class="choose-section"id="motorista">
				<!-- Container -->
				<div class="container">
					<!-- Section Header -->
					<div class="section-header" >
										...
										<div class="choose-slide-content">
											<div class="row">
												<div class="col-lg-7">
													...
													<br>
													<div>class=  alt=""><img src="assets\images\combustivel.png"><p>Tenha de descontos em postos de combustível</p>
													</div>
